...
export default class ViewUtils {
        ...
        return (
            <TouchableHighlight
                ...
                <View style={[styles.setting_item_container]}>
                    ...
                    <Image source={expandableIco ? expandableIco : require('../resource/arrow_right.png')}
                           style={[{
                               marginRight: 10,
                               height: px2dp(40),
                               width: px2dp(22),
    ...
    static getLeftButton(callBack) {
        return <TouchableOpacity
            ...
            <Image
                ...
                source={require('../resource/ic_arrow_back_white_36pt.png')}/>
        </TouchableOpacity>
    }
    ...
    static getBlackLeftButton(callBack) {
        return <TouchableOpacity
            ...
            <Image
                style={{width: 26, height: 26}}
                source={require('../resource/ic_arrow_back_black_36pt.png')}/>
        </TouchableOpacity>
    }
}
